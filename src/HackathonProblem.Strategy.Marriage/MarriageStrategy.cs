...
public class MarriageStrategy : ITeamBuildingStrategy
{
    ...
    {
        // См. задачу об устойчивом паросочетании, алгоритм Гейла-Шепли
        ...
        while (freeTeamLeads.Count > 0)
        {
            ...
            var mostPreferredJunior = juniors.First(junior => junior.Id == mostPreferredJuniorId);
            ...
            {
                var mostPreferredJuniorWishlist = juniorsWishlists.First(w => w.EmployeeId == mostPreferredJuniorId);
